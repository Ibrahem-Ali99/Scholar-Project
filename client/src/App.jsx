    ...
    <Router>
      ...
      <Suspense fallback={<div className="loading-screen">Loading...</div>}>
        <Routes>
          ...
          <Route path="/teacher-dashboard/courses" element={<Course />} />
          <Route path="/teacher-dashboard/students" element={<Student />} />
          <Route path="/teacher-dashboard/bar" element={<BarChart />} />
          <Route path="/teacher-dashboard/pie" element={<PieChart />} />
          <Route path="/teacher-dashboard/line" element={<LineChart />} />
